...
Package with ``installer`` contains a single executable for the automatic installation.
Package with ``portable`` contains all the files in an archive requiring manual extraction and setting up.

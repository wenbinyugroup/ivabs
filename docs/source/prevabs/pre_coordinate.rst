...
There are three coordinate frames used in PreVABS as shown in :numref:`Fig. %s <fig_frames>`:
...
In PreVABS, the definition of the elementary frame **y** follows the rule that the positive direction of |y2| axis is always the same as the direction of the base line, and then |y3| is generated based on |y1| and |y2| according to the right-hand rule. More details about the base line can be found in :numref:`Section %s <section-basepoint-line>`.
